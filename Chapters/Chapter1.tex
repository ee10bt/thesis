\chapter{June 7th - Thermal conductivity and the Earth's interior} % Main chapter title
...
\end{figure}
%---------------------------------------
\subsection{\label{sec:LM}Lower mantle}
%---------------------------------------
...
%---------------------------------------
\subsection{Man-made applications considering \tc}
%---------------------------------------
