...
SECTIONS FOR EACH LAYER, OR SECTIONS FOR DESCRIPTION, PROPERTIES, COMPOSITION ETC.?

%---------------------------------------
\subsection{TALKING ABOUT LAYER PROPERTIES}
%---------------------------------------
Combine with above section?

%---------------------------------------
\subsection{TALKING ABOUT COMPOSITION}
%---------------------------------------
Discuss relevant LM mineralogies, change from upper mantle, core. Spin transition, impurities and stuff.
