...
\end{equation}
%
a simple linear function of temperature, where $m$ is the gradient and $c$ the intercept (as you might expect). With this, we rewrite Equation~\ref{eq.okuda5} one more time,
%
\begin{equation}
...
FITTING CHAI TEA TO COMPOSITION FOR A TEMPERATURE-reference results figure

FITTING G or H AND A
