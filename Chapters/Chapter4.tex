...
RAS POSTER COPY PASTE

We utilise the equilibrium molecular dynamics (EMD) Green-Kubo technique to calculate the lattice thermal conductivities of bridgmanite (\mgsio) and its iron endmember (\fesio). The temperature-dependence of conductivity is determined for each phase at 136~GPa (Figure \ref{fig:kappa-temp_01}), pressure corresponding to the core-mantle boundary (CMB).
